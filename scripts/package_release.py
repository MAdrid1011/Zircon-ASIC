...
def main():
    ...
    target = ROOT / "dist/zircon-asic-0.1.0-rtl-evidence.zip"
    ...
    with zipfile.ZipFile(target, "w", zipfile.ZIP_DEFLATED) as archive:
        ...
        archive.writestr("README.txt", "Zircon-ASIC 0.1.0: 38 qualified configurations.\n"
                          ...
                          "Physical scope and limitations: reports/CONFIGURATIONS.md and reports/DECISIONS.md.\n"
